        ...
        const fetchListing = async () => {
            ...
            try {
                ...
                const mappedState: ListingState = {
                    uae_emirate: (typeof listing.uae_emirate === 'object' ? (listing.uae_emirate.en || listing.uae_emirate.ar) : listing.uae_emirate) || '',
                    city: listing.city || null,
                    category: listing.category || null,
                    offeringType: price.type || null,
                    rentalPeriod: listing.rental_period || null,
                    propertyType: (typeof listing.type === 'object' ? (listing.type.en || listing.type.ar) : listing.type) || '',
                    ...
                    furnishingType: (typeof listing.furnishing_type === 'object' ? (listing.furnishing_type.en || listing.furnishing_type.ar) : listing.furnishing_type) || null,
                    ...
                    amenities: (listing.amenities || []).map((a: any) => typeof a === 'object' ? (a.en || a.ar || '') : String(a)),
